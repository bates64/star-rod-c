...
%.i: %.c
	bash -o pipefail -c ' \
		$(CPP) -w -I../papermario/ver/us/build/include -I../papermario/include -I../papermario/src -I../papermario/assets/us -D_LANGUAGE_C -D_FINALROM -DVERSION=us -DF3DEX_GBI_2 -D_MIPS_SZLONG=32 -nostdinc -DKMC_ASM -DVERSION_US $< -o - \
